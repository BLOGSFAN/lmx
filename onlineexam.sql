...
CREATE TABLE `admin`  (
  `ano` char(6) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '管理员号',
  `adm_psw` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '123456' COMMENT '登录密码，默认为123456',
  `adm_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '管理员姓名',
  `adm_sex` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '男' COMMENT '管理员性别',
  `adm_email` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '管理员邮箱',
  `adm_phone` char(11) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '管理员手机号码',
...
INSERT INTO `admin` VALUES ('123456', '123456', '小张', '男', '123456@qq.com', '13380544897', '2023-02-05 10:06:11');
...
CREATE TABLE `bank_fill_que`  (
  `fill_id` int NOT NULL AUTO_INCREMENT COMMENT '填空题id',
  `fill_content` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '填空题内容',
  `fill_answer` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '填空题答案',
  `compose_flag` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0' COMMENT '是否被组成',
  `answer_explain` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '题目解析',
  `lang_id` int NULL DEFAULT NULL COMMENT '该题所属编程语言',
  PRIMARY KEY (`fill_id`) USING BTREE,
  INDEX `fill_lang_id`(`lang_id` ASC) USING BTREE,
...
INSERT INTO `bank_fill_que` VALUES (35, 'Python是一种面向（）的高级语言', '对象', '1', '', 6);
...
CREATE TABLE `bank_judge_que`  (
  `judge_id` int NOT NULL AUTO_INCREMENT COMMENT '判断题id',
  `judge_content` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '判断题内容',
  `judge_answer` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '判断题答案',
  `compose_flag` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0' COMMENT '是否被组成试卷',
  `answer_explain` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '题目解析',
  `lang_id` int NULL DEFAULT NULL COMMENT '该题所属编程语言',
  PRIMARY KEY (`judge_id`) USING BTREE,
  INDEX `judge_lang_id`(`lang_id` ASC) USING BTREE,
...
INSERT INTO `bank_judge_que` VALUES (25, 'Python是一种跨平台、开源、免费的高级动态编程语言', 'T', '1', '', 6);
...
CREATE TABLE `bank_multiple_choice_que`  (
  `multiple_id` int NOT NULL AUTO_INCREMENT COMMENT '多选题id',
  `multiple_content` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '多选题内容',
  `choice_A` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '选项A',
  `choice_B` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '选项B',
  `choice_C` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '选项C',
  `choice_D` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '选项D',
  `choice_E` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '选项E',
  `choice_F` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '选项F',
  `choice_G` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '选项G',
  `multiple_answer` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '多选题答案',
  `compose_flag` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0' COMMENT '是否被组成试卷',
  `answer_explain` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '题目解析',
  `lang_id` int NULL DEFAULT NULL COMMENT '该题所属编程语言',
  PRIMARY KEY (`multiple_id`) USING BTREE,
  INDEX `multiple_lang_id`(`lang_id` ASC) USING BTREE,
...
INSERT INTO `bank_multiple_choice_que` VALUES (20, '对于python中__new__和__init__的区别，下列说法正确的是？', 'A: __new__是一个静态方法，而__init__是一个实例方法', 'B: __new__方法会返回一个创建的实例，而__init__什么都不返回', 'C:只有在__new__返回一个cls的实例时，后面的__init__才能被调用', 'D:当创建一个新实例时调用__new__，初始化一个实例时用__init__', '', '', '', 'ABCD', '1', '', 6);
...
CREATE TABLE `bank_single_choice_que`  (
  `single_id` int NOT NULL AUTO_INCREMENT COMMENT '单选题id',
  `single_content` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '单选题内容',
  `choice_A` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '选项A',
  `choice_B` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '选项B',
  `choice_C` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '选项C',
  `choice_D` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '选项D',
  ...
  `choice_F` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '选项F',
  `choice_G` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '选项G',
  `single_answer` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '单选题答案',
  `compose_flag` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0' COMMENT '是否被组成试卷',
  `answer_explain` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '题目解析',
  `lang_id` int NULL DEFAULT NULL COMMENT '该题所属编程语言',
  PRIMARY KEY (`single_id`) USING BTREE,
  INDEX `single_lang_id`(`lang_id` ASC) USING BTREE,
...
INSERT INTO `bank_single_choice_que` VALUES (9, '当你编译和运行下面的代码时，会出现下面选项中的哪种情况？[[[ramImages/c0258625-f015-4ac9-9d9b-09056c4296a4]]]', 'A. 编译错误', 'B. 编译通过并输出结果false', 'C. 编译通过并输出结果true', 'D. 编译通过并输出结果null', NULL, NULL, NULL, 'A', '1', NULL, 1);
...
INSERT INTO `bank_single_choice_que` VALUES (17, '下面代码的运行结果是（）[[[ramImages/cbee48d4-56b7-4778-acb2-e13b800d4b50]]]', 'A. 代码编程成功，并输出”s=”', 'B.代码编译成功，并输出”s=null”', 'C. 由于String s没有初始化，代码不能编译通过', 'D. 代码编译成功，但捕获到NullPointException异常', NULL, NULL, NULL, 'C', '1', NULL, 1);
...
INSERT INTO `bank_single_choice_que` VALUES (38, '执行下面代码，请问输出结果为（）[[[ramImages/6fc0b2c6-ecde-417d-a21c-2cd2e3e5798c]]][[[ramImages/02648842-ee3c-4f8c-90a9-b1055d191447]]]', '顺顺 顺顺', '丰丰 丰丰', '顺顺 丰丰', '丰丰 顺顺', '', '', '', 'A', '1', '', 6);
...
CREATE TABLE `paper`  (
  ...
  `paper_duration` int NULL DEFAULT NULL COMMENT '考试时长，单位秒',
  `paper_difficulty` int NULL DEFAULT NULL COMMENT '试卷难度',
  `paper_attention` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '考试注意事项',
  `paper_type` int NULL DEFAULT NULL COMMENT '组卷机制，1为随机，2为固定',
  `single_score` int NULL DEFAULT NULL COMMENT '单选题分配分数',
  `multiple_score` int NULL DEFAULT NULL COMMENT '多选题分配分数',
  `judge_score` int NULL DEFAULT NULL COMMENT '判断题分配分数',
  `fill_score` int NULL DEFAULT NULL COMMENT '填空题分配分数',
  `lang_id` int NULL DEFAULT NULL COMMENT '试卷所属编程语言',
  `participate_num` int NULL DEFAULT 0 COMMENT '已参加人数',
  PRIMARY KEY (`paper_id`) USING BTREE,
  INDEX `paper_lang_id`(`lang_id` ASC) USING BTREE,
...
INSERT INTO `paper` VALUES (12, 'Python是一种面向 对象的高级语言', '2023-02-06 20:04:27', 600, 5, 'Python是一种面向 对象的高级语言', 2, 1, 1, 1, 1, 6, 1);
...
CREATE TABLE `paper_que`  (
  `que_id` int NOT NULL AUTO_INCREMENT COMMENT '问题id',
  `que_type` int NULL DEFAULT NULL COMMENT '题类型',
  `single_id` int NULL DEFAULT NULL COMMENT '单选题id',
  `multiple_id` int NULL DEFAULT NULL COMMENT '多选题id',
  `judge_id` int NULL DEFAULT NULL COMMENT '判断题id',
  `fill_id` int NULL DEFAULT NULL COMMENT '填空题id',
  `paper_id` int NULL DEFAULT NULL COMMENT '试卷id',
  PRIMARY KEY (`que_id`) USING BTREE,
  INDEX `que_single_id`(`single_id` ASC) USING BTREE,
  INDEX `que_multiple_id`(`multiple_id` ASC) USING BTREE,
  INDEX `que_judge_id`(`judge_id` ASC) USING BTREE,
  INDEX `que_fill_id`(`fill_id` ASC) USING BTREE,
  INDEX `que_paper_id`(`paper_id` ASC) USING BTREE,
...
INSERT INTO `paper_que` VALUES (140, 1, 38, NULL, NULL, NULL, 12);
INSERT INTO `paper_que` VALUES (141, 2, NULL, 20, NULL, NULL, 12);
INSERT INTO `paper_que` VALUES (142, 3, NULL, NULL, 25, NULL, 12);
INSERT INTO `paper_que` VALUES (143, 4, NULL, NULL, NULL, 35, 12);
...
CREATE TABLE `programing_language`  (
  `lang_id` int NOT NULL AUTO_INCREMENT COMMENT '编程语言id',
  `lang_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '编程语言名称',
  `lang_desc` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '编程语言描述',
  `lang_img_src` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '编程语言图标',
  `lang_create_time` datetime NULL DEFAULT NULL COMMENT '编程语言创建时间',
  `lang_created_by` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '编程语言被创建者',
  `lang_change_time` datetime NULL DEFAULT NULL COMMENT '编程语言最近修改时间',
  `lang_last_changer` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '编程语言最近被修改者',
  `is_recommend` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0' COMMENT '是否在学生首页显示推荐，默认为0不推荐，1为推荐',
...
-- ----------------------------
INSERT INTO `programing_language` VALUES (1, 'Java', 'Java工程师能力评估', 'http://rpl53hgi1.hn-bkt.clouddn.com/programImages/java.png?e=1675566043&token=mQ6jHS-iCY87zVo_Qe1-o6DQn6-9JzZma0qGzMKV:12PO9yv-MsVRob3SDxWplGAgW5A=', '2019-03-13 03:53:24', '小张', '2019-04-20 20:18:07', '小张', '1');
INSERT INTO `programing_language` VALUES (2, 'C++', 'C++工程师能力评估', 'http://rpl53hgi1.hn-bkt.clouddn.com/programImages/c%2B%2B.png?e=1675566084&token=mQ6jHS-iCY87zVo_Qe1-o6DQn6-9JzZma0qGzMKV:WlCvT7J3uzKFf5hP6TOzboMIJmY=', '2019-03-13 03:54:24', '小张', '2019-04-20 20:18:16', '小张', '0');
INSERT INTO `programing_language` VALUES (3, 'Android', 'Android工程师能力评估', 'http://rpl53hgi1.hn-bkt.clouddn.com/programImages/Android.png?e=1675566095&token=mQ6jHS-iCY87zVo_Qe1-o6DQn6-9JzZma0qGzMKV:KryKrrxXExlbIbcoRH_WHVlVPYo=', '2019-03-13 03:55:09', '小张', '2019-04-20 20:18:24', '小张', '1');
INSERT INTO `programing_language` VALUES (4, 'IOS', 'IOS工程师能力评估', 'http://rpl53hgi1.hn-bkt.clouddn.com/programImages/IOS.png?e=1675566055&token=mQ6jHS-iCY87zVo_Qe1-o6DQn6-9JzZma0qGzMKV:Jk1RgL-jIUJHxgBMYjMVm6CTgXA=', '2019-03-13 03:55:43', '小张', '2019-04-20 20:18:30', '小张', '0');
INSERT INTO `programing_language` VALUES (5, 'php', 'php工程师能力评估', 'http://rpl53hgi1.hn-bkt.clouddn.com/programImages/php.png?e=1675565999&token=mQ6jHS-iCY87zVo_Qe1-o6DQn6-9JzZma0qGzMKV:iNrPngwiKB6bI1fgBvrqOPEPy4c=', '2019-03-13 03:56:37', '小张', '2019-04-20 20:18:37', '小张', '1');
INSERT INTO `programing_language` VALUES (6, 'Python', 'Python工程师能力评估', 'http://rpl53hgi1.hn-bkt.clouddn.com/programImages/Python.png?e=1675565988&token=mQ6jHS-iCY87zVo_Qe1-o6DQn6-9JzZma0qGzMKV:4pBawlu1aiwon-s6wYQqRRKbYNI=', '2019-03-13 03:58:59', '小张', '2019-04-20 20:18:45', '小张', '1');
INSERT INTO `programing_language` VALUES (7, 'Ruby', 'Ruby工程师能力评估', 'http://rpl53hgi1.hn-bkt.clouddn.com/programImages/Ruby.png?e=1675565965&token=mQ6jHS-iCY87zVo_Qe1-o6DQn6-9JzZma0qGzMKV:4esYpx6DY-wA2P7eWkM7wuQtuI0=', '2019-03-13 03:59:59', '小张', '2019-04-20 20:19:31', '小张', '0');
INSERT INTO `programing_language` VALUES (8, 'Go', 'Go工程师能力评估', 'http://rpl53hgi1.hn-bkt.clouddn.com/programImages/Go.png?e=1675566074&token=mQ6jHS-iCY87zVo_Qe1-o6DQn6-9JzZma0qGzMKV:pQkSNAt3VbuLYxWjBfBCBkxwGvA=', '2019-03-13 04:00:36', '小张', '2019-04-20 20:19:03', '小张', '0');
INSERT INTO `programing_language` VALUES (9, 'JavaScript', 'Web工程师能力评估', 'http://rpl53hgi1.hn-bkt.clouddn.com/programImages/JavaScript.png?e=1675566031&token=mQ6jHS-iCY87zVo_Qe1-o6DQn6-9JzZma0qGzMKV:51vvnuslJ24HWlQ0fZbk5b-QRvg=', '2019-03-13 04:03:40', '小张', '2019-04-20 20:19:16', '小张', '1');
...
CREATE TABLE `student`  (
  `sno` char(12) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '主键，学生学号',
  `stu_psw` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '123456' COMMENT '登录密码，默认为123456',
  `stu_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '学生姓名',
  `stu_img_src` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '头像链接',
  `stu_sex` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '男' COMMENT '学生性别',
  `stu_email` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '学生邮箱',
  `stu_phone` char(11) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '学生手机号码',
  `stu_create_time` datetime NOT NULL COMMENT '学生注册时间',
  `stu_last_login_time` datetime NULL DEFAULT NULL COMMENT '学生最近登录时间',
  `stu_status` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '1' COMMENT '学生登录状态',
  `stu_security_code` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '123456' COMMENT '安全码用于密码找回',
...
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES ('123456789123', '123456789123', '何朋伟', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/3f56b012-8a5e-41bf-9bc9-2f49d58e73c8', '男', '2318745133@qq.com', '15256190353', '2023-02-05 10:23:21', '2023-02-11 20:56:36', '1', '123456');
INSERT INTO `student` VALUES ('201511314001', '123456', '小四', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '1234@qq.com', '13458956478', '2019-04-28 01:20:39', NULL, '1', '123456');
INSERT INTO `student` VALUES ('201511314002', '123456', '小五', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '1234@qq.com', '13458956478', '2019-04-28 01:21:10', NULL, '1', '123456');
INSERT INTO `student` VALUES ('201511314003', '123456', '小刘', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '12345@qq.com', '13565895641', '2019-04-28 01:21:45', '2019-04-28 01:21:47', '1', '123456');
INSERT INTO `student` VALUES ('201511314301', '123456', '小三', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '123456789@qq.com', '13526459823', '2019-04-28 00:46:29', '2019-04-28 00:47:27', '1', '123456');
INSERT INTO `student` VALUES ('201511314321', '123456', '小马', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '1234567@qq.com', '13658952365', '2019-04-28 00:57:25', '2019-04-28 00:57:28', '1', '123456');
INSERT INTO `student` VALUES ('201521314301', '123456', '谢永宁', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '123456@qq.com', '13254896548', '2019-03-10 20:15:37', '2019-04-28 01:44:43', '1', '123456');
INSERT INTO `student` VALUES ('201521314302', '123456', '李四', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '123456@qq.com', '13625498549', '2019-03-11 18:37:18', '2019-04-15 20:16:00', '1', '123456');
INSERT INTO `student` VALUES ('201521314303', '123456', '马瑞欣', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '女', '123456@qq.com', '13625894562', '2019-03-31 21:19:19', '2019-04-15 20:17:15', '1', '123456');
INSERT INTO `student` VALUES ('201521314304', '123456', '阿水', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '123456@qq.com', '13652485962', '2019-03-31 22:48:05', '2019-04-15 20:17:35', '1', '123456');
INSERT INTO `student` VALUES ('201521314305', '123456', '马导', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '女', '123456@qq.com', '13452685942', '2019-03-31 22:59:39', '2019-04-15 20:18:05', '1', '123456');
INSERT INTO `student` VALUES ('201521314310', '123456', '叶国冲', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '1234567@qq.com', '13754695862', '2019-03-11 01:10:22', '2019-04-15 20:18:14', '1', '123456');
INSERT INTO `student` VALUES ('201521314316', '123456', '汤梓豪', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '123456@qq.com', '13225849856', '2019-03-03 18:59:47', '2019-04-15 20:18:29', '1', '123456');
INSERT INTO `student` VALUES ('201521314318', '123456', '张家豪', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '123456@qq.com', '13632289756', '2019-03-10 20:10:30', '2019-04-15 20:19:25', '1', '123456');
INSERT INTO `student` VALUES ('201521314319', '123456', '罗建宏', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '123456@qq.com', '13545687959', '2019-03-10 20:12:14', '2019-04-15 20:20:19', '1', '123456');
INSERT INTO `student` VALUES ('201521314321', '123456', '马伟涛', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '815699563@qq.com', '13602890590', '2019-03-01 18:35:26', '2019-05-07 16:31:01', '1', '123456');
INSERT INTO `student` VALUES ('201521314322', '123456', '杨铎', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '123456@qq.com', '13225849856', '2019-03-03 18:25:42', '2019-04-15 20:20:33', '1', '123456');
INSERT INTO `student` VALUES ('201521314323', '123456', '陈国', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '123456@136.com', '15524752689', '2019-03-03 17:20:56', '2019-04-15 20:20:48', '1', '123456');
INSERT INTO `student` VALUES ('201521314330', '123456', '魏伟康', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '12345678@qq.com', '18054687965', '2019-03-10 20:17:37', '2019-04-15 20:21:27', '1', '123456');
INSERT INTO `student` VALUES ('201521314332', '123456', '陈荣涛', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '123456@qq.com', '13456987532', '2019-03-10 20:20:32', '2019-04-15 20:22:01', '1', '123456');
INSERT INTO `student` VALUES ('201521314501', '123456', '小明', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '123456@qq.com', '13625248596', '2019-04-08 03:32:29', '2019-04-15 20:22:45', '1', '123456');
INSERT INTO `student` VALUES ('201521314502', '123456', '小红', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '女', '123456@qq.com', '13456258956', '2019-04-08 03:33:00', '2019-04-15 20:22:59', '1', '123456');
INSERT INTO `student` VALUES ('201521314503', '123456', '小黄', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '123456@qq.com', '13456258958', '2019-04-08 03:33:20', '2019-04-15 20:23:15', '1', '123456');
INSERT INTO `student` VALUES ('201521314505', '123456', '小飞', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '123456@qq.com', '13895487596', '2019-04-08 03:33:50', '2019-04-15 20:23:38', '1', '123456');
INSERT INTO `student` VALUES ('201521314506', '123456', '小亮', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '123456@qq.com', '13895487599', '2019-04-08 03:34:21', '2019-04-15 20:24:03', '1', '123456');
INSERT INTO `student` VALUES ('201521314507', '123456', '红苹果', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '女', '123456@qq.com', '13895487545', '2019-04-08 03:34:35', '2019-04-15 20:24:19', '1', '123456');
INSERT INTO `student` VALUES ('201521314508', '123456', '小敏', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '女', '123456@qq.com', '13895487548', '2019-04-08 03:34:46', '2019-04-15 20:24:33', '1', '123456');
INSERT INTO `student` VALUES ('201521314610', '123456', '飘雪国', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '123456@qq.com', '13526489523', '2019-04-08 03:48:40', '2019-04-15 20:24:54', '1', '123456');
INSERT INTO `student` VALUES ('201521314700', '123456', '咸蛋超人', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '8954233@qq.com', '18952484562', '2019-04-08 15:42:49', '2019-04-15 20:25:09', '1', '123456');
INSERT INTO `student` VALUES ('201521314701', '123456', '泽泽', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', '123456@qq.com', '13526458952', '2019-04-08 15:44:36', '2019-04-15 20:25:22', '1', '123456');
INSERT INTO `student` VALUES ('201521314900', '123456', '张阿三', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', NULL, NULL, '2019-04-16 22:40:19', '2019-04-28 01:45:49', '1', '123456');
INSERT INTO `student` VALUES ('201521314901', '123456', '张小红', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '女', NULL, NULL, '2019-04-16 22:40:19', NULL, '1', '123456');
INSERT INTO `student` VALUES ('201521314902', '123456', '李阿四', 'http://rpl53hgi1.hn-bkt.clouddn.com/profiles/74a154fb-d44e-4e62-88e7-5ebb90872a8a', '男', NULL, NULL, '2019-04-16 22:40:19', NULL, '1', '123456');
...
CREATE TABLE `student_feedback`  (
  ...
  `feedback_content` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '反馈内容',
  `feedback_create_time` datetime NOT NULL COMMENT '反馈创建时间',
  `sno` char(12) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '学号',
  `stu_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '学生姓名',
  `adm_answer` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '管理员回复',
  `ano` char(6) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '管理员号',
  `adm_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '管理员姓名',
  `feedback_status` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0' COMMENT '留言状态0为管理员未读，1为管理员已读学生未读，2为学生已读',
  `reply_time` datetime NULL DEFAULT NULL COMMENT '管理员回复时间',
  PRIMARY KEY (`feedback_id`) USING BTREE,
  INDEX `feedback_sno`(`sno` ASC) USING BTREE,
  INDEX `feedback_ano`(`ano` ASC) USING BTREE,
...
INSERT INTO `student_feedback` VALUES (135, '#得意;', '2019-04-26 22:04:23', '201521314321', '马伟涛', '#闭嘴;', '123456', '小张', '1', '2023-02-10 21:19:42');
...
CREATE TABLE `student_home_rotation_img`  (
  `img_id` int NOT NULL AUTO_INCREMENT COMMENT '轮播图id',
  `img_title` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '轮播图标题',
  `img_src` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '轮播图图片地址',
  `img_create_time` datetime NOT NULL COMMENT '轮播图创建时间',
  `ano` int NOT NULL COMMENT '创建轮播图的管理员id',
  `adm_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建轮播图的管理员姓名',
...
-- ----------------------------
INSERT INTO `student_home_rotation_img` VALUES (1, 'Android', 'http://rpl53hgi1.hn-bkt.clouddn.com/programImages/49bc1081-bced-46de-a18b-81cbb1007be7', '2019-03-05 01:48:22', 123456, '小张');
INSERT INTO `student_home_rotation_img` VALUES (2, 'c++', 'http://rpl53hgi1.hn-bkt.clouddn.com/programImages/49c9e510-3a5d-4ba6-ab1b-275940201494', '2019-03-05 01:48:45', 123456, '小张');
INSERT INTO `student_home_rotation_img` VALUES (3, 'IOS', 'http://rpl53hgi1.hn-bkt.clouddn.com/programImages/1d7ad9da-be82-40d6-931b-980c5d3fdbb2', '2019-03-05 01:49:03', 123456, '小张');
INSERT INTO `student_home_rotation_img` VALUES (4, 'php', 'http://rpl53hgi1.hn-bkt.clouddn.com/programImages/bc615c5c-deff-415a-82d1-af3e3b431af8', '2019-03-05 01:49:17', 123456, '小张');
INSERT INTO `student_home_rotation_img` VALUES (5, 'Go', 'http://rpl53hgi1.hn-bkt.clouddn.com/programImages/fbff548f-c67a-454c-ba82-39f27c2548b2', '2019-04-20 17:18:40', 123456, '小张');
INSERT INTO `student_home_rotation_img` VALUES (6, 'JavaScript', 'http://rpl53hgi1.hn-bkt.clouddn.com/programImages/4d711082-fd0e-4924-954a-6951b87bf5a5', '2019-04-20 17:19:01', 123456, '小张');
...
CREATE TABLE `student_paper_answer`  (
  `answer_id` int NOT NULL AUTO_INCREMENT COMMENT '学生答卷答案id',
  `stu_answer` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '学生答卷答案',
  `isCorrect` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '答案是否正确',
  `que_id` int NULL DEFAULT NULL COMMENT '问题id',
  `paper_id` int NULL DEFAULT NULL COMMENT '试卷id',
  `sno` char(12) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '学号',
  `isCollect` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0' COMMENT '是否被收藏,0为否，1为是',
  PRIMARY KEY (`answer_id`) USING BTREE,
  INDEX `answer_que_id`(`que_id` ASC) USING BTREE,
  INDEX `answer_paper_id`(`paper_id` ASC) USING BTREE,
  INDEX `answer_sno`(`sno` ASC) USING BTREE,
...
INSERT INTO `student_paper_answer` VALUES (662, 'A', '1', 140, 12, '123456789123', '1');
INSERT INTO `student_paper_answer` VALUES (663, 'ABCD', '1', 141, 12, '123456789123', '0');
INSERT INTO `student_paper_answer` VALUES (664, 'T', '1', 142, 12, '123456789123', '0');
INSERT INTO `student_paper_answer` VALUES (665, '对象', '1', 143, 12, '123456789123', '0');
...
CREATE TABLE `student_paper_score`  (
  `score_id` int NOT NULL AUTO_INCREMENT COMMENT '学生答卷分数id',
  `score` int NULL DEFAULT NULL COMMENT '学生答卷总分',
  `time_used` int NULL DEFAULT NULL COMMENT '答题花费时间，单位毫秒',
  `start_time` datetime NULL DEFAULT NULL COMMENT '答题开始时间',
  `end_time` datetime NULL DEFAULT NULL COMMENT '答题结束时间',
  `sno` char(12) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '学号',
  `paper_id` int NULL DEFAULT NULL COMMENT '试卷id',
  PRIMARY KEY (`score_id`) USING BTREE,
  INDEX `score_sno`(`sno` ASC) USING BTREE,
  INDEX `score_paper_id`(`paper_id` ASC) USING BTREE,
...
INSERT INTO `student_paper_score` VALUES (45, 4, 41146, '2023-02-06 20:05:17', '2023-02-06 20:05:58', '123456789123', 12);
...
CREATE TABLE `teacher`  (
  `tno` char(6) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '教工号',
  `tea_psw` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '123456' COMMENT '登录密码，默认为123456',
  `tea_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '教师姓名',
  `tea_sex` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '男' COMMENT '教师性别',
  `tea_email` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '教师邮箱',
  `tea_phone` char(11) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '教师手机号码',
...
INSERT INTO `teacher` VALUES ('123456', '123456', '胡老师', '男', '123456@qq.com', '13229622789', '2023-02-05 10:03:16');
INSERT INTO `teacher` VALUES ('654321', '123456', '鸡你太美', '女', '123456@qq.com', '17849464587', NULL);
...
CREATE TABLE `teacher_notice`  (
  `notice_id` int NOT NULL AUTO_INCREMENT COMMENT '教师公告id',
  ...
  `tea_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建公告的教师姓名',
  `tno` char(6) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '创建公告教工号',
  `sno` char(12) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '学号',
  `is_see` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '是否查看',
  PRIMARY KEY (`notice_id`) USING BTREE,
  INDEX `notice_tno`(`tno` ASC) USING BTREE,
  INDEX `notice_sno`(`sno` ASC) USING BTREE,
...
-- ----------------------------
INSERT INTO `teacher_notice` VALUES (1, '2023年3月1号下午两点到四点将会有一场计算机图形学在线考试，请同学们做好相关考试准备。', '2023-02-06 19:43:07', '胡老师', '123456', NULL, NULL);
INSERT INTO `teacher_notice` VALUES (2, '2023年3月2号下午两点到四点将会有一场Java语言程序设计在线考试，请同学们做好相关考试准备。', '2023-02-06 19:43:23', '高老师', '100001', NULL, NULL);
INSERT INTO `teacher_notice` VALUES (3, '2023年3月3号下午两点到四点将会有一场数据库原理与设计在线考试，请同学们做好相关考试准备。', '2023-02-06 19:43:41', '杨老师', '100000', NULL, NULL);
INSERT INTO `teacher_notice` VALUES (4, '2023年3月4号下午两点到四点将会有一场C++语言程序设计在线考试，请同学们做好相关考试准备。', '2023-02-06 19:43:41', '杨老师', '100000', NULL, NULL);
INSERT INTO `teacher_notice` VALUES (5, '2023年3月5号下午两点到四点将会有一场Web程序设计在线考试，请同学们做好相关考试准备。', '2023-02-06 19:43:41', '侯老师', '100100', NULL, NULL);
INSERT INTO `teacher_notice` VALUES (6, '2023年3月6号下午两点到四点将会有一场Android程序设计在线考试，请同学们做好相关考试准备。', '2023-02-06 19:43:41', '侯老师', '100100', NULL, NULL);
INSERT INTO `teacher_notice` VALUES (7, '2023年3月7号下午两点到四点将会有一场计算机网络编程在线考试，请同学们做好相关考试准备。', '2023-02-06 19:43:41', '王老师', '100860', NULL, NULL);
INSERT INTO `teacher_notice` VALUES (8, '2023年3月8号下午两点到四点将会有一场PHP语言程序设计在线考试，请同学们做好相关考试准备。', '2023-02-06 19:43:41', '侯老师', '100100', NULL, NULL);
INSERT INTO `teacher_notice` VALUES (9, '2023年3月9号下午两点到四点将会有一场Ruby语言程序设计在线考试，请同学们做好相关考试准备。', '2023-02-06 19:43:41', '高老师', '100001', NULL, NULL);
INSERT INTO `teacher_notice` VALUES (10, '2023年3月10号下午两点到四点将会有一场JavaScript语言程序设计在线考试，请同学们做好相关考试准备。', '2023-02-06 19:43:41', '侯老师', '100100', NULL, NULL);
INSERT INTO `teacher_notice` VALUES (15, '2023年3月11号下午两点到四点将会有一场计算机图形学在线考试，请同学们做好相关考试准备。', '2023-02-06 19:43:41', '胡老师', '123456', NULL, NULL);
INSERT INTO `teacher_notice` VALUES (16, '2023年3月12号下午两点到四点将会有一场计算机图形学在线考试，请同学们做好相关考试准备。', '2023-02-06 19:43:41', '胡老师', '123456', NULL, NULL);
INSERT INTO `teacher_notice` VALUES (37, '2023年4月22号下午两点到四点将会有一场计算机图形学在线考试，请同学们做好相关考试准备。', '2023-02-06 19:43:41', '胡老师', '123456', NULL, NULL);
INSERT INTO `teacher_notice` VALUES (39, '2023年4月23号下午两点到四点将会有一场计算机图形学在线考试，请同学们做好相关考试准备。', '2023-02-06 19:43:41', '胡老师', '123456', NULL, NULL);
INSERT INTO `teacher_notice` VALUES (42, '2023年4月25号下午两点到四点将会有一场前端测试在线考试，请同学们做好相关考试准备。', '2023-02-06 19:43:41', '胡老师', '123456', NULL, NULL);
INSERT INTO `teacher_notice` VALUES (47, '2023年5月7号下午两点到四点将会有一场前端测试在线考试，请同学们做好相关考试准备。', '2023-02-06 19:43:41', '胡老师', '123456', NULL, NULL);
